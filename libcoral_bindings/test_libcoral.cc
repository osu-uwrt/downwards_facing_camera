...
void reportTime(int num, std::chrono::time_point<std::chrono::high_resolution_clock> start,
                std::chrono::time_point<std::chrono::high_resolution_clock> stop) {
  int64_t time_us = std::chrono::duration_cast<std::chrono::microseconds>(stop - start).count();
  std::cout << "Loop " << num << ": " << time_us / 1000 << "." << time_us % 1000 << "ms" << std::endl;
}
