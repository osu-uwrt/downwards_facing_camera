set(FLAGS "-O3 -ffunction-sections -fdata-sections -D'RCUTILS_LOG_MIN_SEVERITY=RCUTILS_LOG_MIN_SEVERITY_NONE'")

if ($ENV{UROS_RPI_CROSS_COMPILE})
    ...
    set(FLAGS "${FLAGS} -march=armv8.2-a -mcpu=cortex-a76")
endif()
